# BAS-kernel
A kernel with alot features like GOP and PCI support with uefi bootlaoder. It has AHCI (The massstorage ATA driver in intel). So that you can control the ports and drives on your computer. It can handle many interrupts like PS2 Mosue and keyboard. It's also very flexible and all functions are implented as understandable as they could. You can modify it in anyway you want.
